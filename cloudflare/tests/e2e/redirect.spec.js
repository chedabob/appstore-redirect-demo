...
// Use page.request.fetch with maxRedirects:0 so we inspect the 302 directly.
// page.request shares the context's user-agent, so device spoofing still applies.
